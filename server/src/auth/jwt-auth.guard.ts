...
export class JwtAuthGuard extends AuthGuard('jwt') {
  ...
  public handleRequest(error: any, user: any, info: Error): any {
    ...
    if(info instanceof TokenExpiredError) {  // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment
    ...
    if(error || !user) {  // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment
